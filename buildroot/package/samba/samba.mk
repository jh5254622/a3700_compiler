...
SAMBA_CONF_OPTS = \
	...
	--with-privatedir=/usr/data/samba/private \
	--with-configdir=/usr/data/samba \
	--with-statedir=/usr/data/samba \
...
#	$(INSTALL) -m 0644 -D package/samba/simple.conf $(TARGET_DIR)/etc/samba/smb.conf
	$(INSTALL) -m 0644 -D package/samba/simple.conf user_files/samba/smb.conf
endef
