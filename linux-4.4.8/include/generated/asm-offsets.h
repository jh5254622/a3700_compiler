...
#define THREAD_CPU_CONTEXT 1856 /* offsetof(struct task_struct, thread.cpu_context)	// */
...
#define VCPU_CONTEXT 304 /* offsetof(struct kvm_vcpu, arch.ctxt)	// */
...
#define VCPU_ESR_EL2 1408 /* offsetof(struct kvm_vcpu, arch.fault.esr_el2)	// */
#define VCPU_FAR_EL2 1416 /* offsetof(struct kvm_vcpu, arch.fault.far_el2)	// */
#define VCPU_HPFAR_EL2 1424 /* offsetof(struct kvm_vcpu, arch.fault.hpfar_el2)	// */
#define VCPU_DEBUG_FLAGS 1432 /* offsetof(struct kvm_vcpu, arch.debug_flags)	// */
#define VCPU_DEBUG_PTR 1440 /* offsetof(struct kvm_vcpu, arch.debug_ptr)	// */
#define DEBUG_BCR 0 /* offsetof(struct kvm_guest_debug_arch, dbg_bcr)	// */
#define DEBUG_BVR 128 /* offsetof(struct kvm_guest_debug_arch, dbg_bvr)	// */
#define DEBUG_WCR 256 /* offsetof(struct kvm_guest_debug_arch, dbg_wcr)	// */
#define DEBUG_WVR 384 /* offsetof(struct kvm_guest_debug_arch, dbg_wvr)	// */
#define VCPU_HCR_EL2 1392 /* offsetof(struct kvm_vcpu, arch.hcr_el2)	// */
#define VCPU_MDCR_EL2 1400 /* offsetof(struct kvm_vcpu, arch.mdcr_el2)	// */
#define VCPU_IRQ_LINES 3520 /* offsetof(struct kvm_vcpu, arch.irq_lines)	// */
#define VCPU_HOST_CONTEXT 2472 /* offsetof(struct kvm_vcpu, arch.host_cpu_context)	// */
#define VCPU_HOST_DEBUG_STATE 2480 /* offsetof(struct kvm_vcpu, arch.host_debug_state)	// */
#define VCPU_TIMER_CNTV_CTL 3360 /* offsetof(struct kvm_vcpu, arch.timer_cpu.cntv_ctl)	// */
#define VCPU_TIMER_CNTV_CVAL 3368 /* offsetof(struct kvm_vcpu, arch.timer_cpu.cntv_cval)	// */
#define KVM_TIMER_CNTVOFF 3056 /* offsetof(struct kvm, arch.timer.cntvoff)	// */
#define KVM_TIMER_ENABLED 3048 /* offsetof(struct kvm, arch.timer.enabled)	// */
#define VCPU_KVM 0 /* offsetof(struct kvm_vcpu, kvm)	// */
#define VCPU_VGIC_CPU 2992 /* offsetof(struct kvm_vcpu, arch.vgic_cpu)	// */
#define VGIC_V2_CPU_HCR 56 /* offsetof(struct vgic_cpu, vgic_v2.vgic_hcr)	// */
#define VGIC_V2_CPU_VMCR 60 /* offsetof(struct vgic_cpu, vgic_v2.vgic_vmcr)	// */
#define VGIC_V2_CPU_MISR 64 /* offsetof(struct vgic_cpu, vgic_v2.vgic_misr)	// */
#define VGIC_V2_CPU_EISR 72 /* offsetof(struct vgic_cpu, vgic_v2.vgic_eisr)	// */
#define VGIC_V2_CPU_ELRSR 80 /* offsetof(struct vgic_cpu, vgic_v2.vgic_elrsr)	// */
#define VGIC_V2_CPU_APR 88 /* offsetof(struct vgic_cpu, vgic_v2.vgic_apr)	// */
#define VGIC_V2_CPU_LR 92 /* offsetof(struct vgic_cpu, vgic_v2.vgic_lr)	// */
#define VGIC_V3_CPU_SRE 64 /* offsetof(struct vgic_cpu, vgic_v3.vgic_sre)	// */
#define VGIC_V3_CPU_HCR 56 /* offsetof(struct vgic_cpu, vgic_v3.vgic_hcr)	// */
#define VGIC_V3_CPU_VMCR 60 /* offsetof(struct vgic_cpu, vgic_v3.vgic_vmcr)	// */
#define VGIC_V3_CPU_MISR 68 /* offsetof(struct vgic_cpu, vgic_v3.vgic_misr)	// */
#define VGIC_V3_CPU_EISR 72 /* offsetof(struct vgic_cpu, vgic_v3.vgic_eisr)	// */
#define VGIC_V3_CPU_ELRSR 76 /* offsetof(struct vgic_cpu, vgic_v3.vgic_elrsr)	// */
#define VGIC_V3_CPU_AP0R 80 /* offsetof(struct vgic_cpu, vgic_v3.vgic_ap0r)	// */
#define VGIC_V3_CPU_AP1R 96 /* offsetof(struct vgic_cpu, vgic_v3.vgic_ap1r)	// */
#define VGIC_V3_CPU_LR 112 /* offsetof(struct vgic_cpu, vgic_v3.vgic_lr)	// */
#define VGIC_CPU_NR_LR 48 /* offsetof(struct vgic_cpu, nr_lr)	// */
#define KVM_VTTBR 2696 /* offsetof(struct kvm, arch.vttbr)	// */
#define KVM_VGIC_VCTRL 2736 /* offsetof(struct kvm, arch.vgic.vctrl_base)	// */
