...
/* Version */
#define CONFIG_IDENT_STRING             "  DAMAI version: devel-16.07.0"
...
#define RCVR_IP_ADDR			"192.168.0.100"
...
#define CONFIG_BOOTDELAY                3/*0 JJJHHH*/
...
#define DAMAI_JH_FIX 1  /*1:norflash 2:emmc 3:nand*/
#ifdef DAMAI_JH_FIX
#if(DAMAI_JH_FIX == 1)
	#define CONFIG_BOOTCOMMAND		"sf probe; sf read 0x2000000 0x310000 0x600000;sf read 0x1000000 0x300000 0x10000;setenv bootargs $console root=/dev/mtdblock5 rw rootfstype=squashfs;bootm 0x2000000 - 0x1000000"
/*#elif(DAMAI_JH_FIX == 2)*/
/*#elif(DAMAI_JH_FIX == 3)*/
#else
...
#ifndef CONFIG_USB_STORAGE//JJJHHH
...
/* Add network parameters when network command is enabled */
	...
	/* Environment */
	#define CONFIG_IPADDR		192.168.8.10	/* In order to cause an error */
	#define CONFIG_SERVERIP		192.168.8.130	/* In order to cause an error */
